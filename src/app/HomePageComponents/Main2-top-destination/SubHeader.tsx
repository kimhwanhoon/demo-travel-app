export default function Main2_subHeader() {
  return (
    <section className="flex justify-between capitalize mb-4 md:mb-5 xl:mb-6">
      <div>
        ...
        <p className="text-gray-dark text-sm md:text-base font-normal capitalize leading-6 text-secondary 4xl:text-lg">
          Find out our top destinations to visit in Korea.
        </p>
      </div>
    </section>
  );
